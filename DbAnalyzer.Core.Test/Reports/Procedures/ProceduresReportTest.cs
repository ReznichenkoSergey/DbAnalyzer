...
namespace DbAnalyzer.Core.Test.Reports.Procedures
{
    public class ProceduresReportTest
    {
        ...
        private readonly Mock<ILogger<ProceduresReport>> _logger;
        ...
        public ProceduresReportTest()
        {
            ...
            _logger = new Mock<ILogger<ProceduresReport>>();
        }
        ...
        public async Task GetReportAsync_Should_Generate_Correct_Report()
        {
            ...
            var repos = new ProceduresReport(_procedureExplorer.Object, _execPlanExplorer.Object, _logger.Object);

            //Act
            var actual = await repos.GetReportAsync(GetQueryDto());
        ...
        private ProceduresReportQueryDto GetQueryDto()
            => new ProceduresReportQueryDto()
            {
                ShowWithErrors = true,
